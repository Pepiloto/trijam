...
for x in range(1, c.TURRET_LEVELS + 1):
    ...
    turret_spritesheet.append(turret_sheet)
...
def draw_text(text: str, font: pg.font.Font, text_color, x: int, y: int):
...
def create_turret(mouse_pos):
    ...
    if world.tile_map[mouse_tile_num] == 7:
        ...
        if space_is_free == True:
            new_turret = Turret(turret_spritesheet, mouse_tile_x, mouse_tile_y, shot_fx)
...
while run:
    ...
    if game_over == False:
        ...
        if placing_turret:
            ...
            if pg.mouse.get_pos()[0] < c.SCREEN_WIDTH:
        ...
        if game_outcome == -1:
            ...
            draw_text("YOU WON", large_font, "grey0", 315, 230)
